...
<body>
	<header>
		<p class="h1 bg-secondary fw-bold text-white text-center display-2">Delete
			Employee</p>
	</header>
	<div class="head">
		<a href="adminInside.html"
			class="border-top m4 btn btn-danger text-center"
			style="margin-bottom: 10px; width: 150px; font-family: cursive; margin-left: 20px;">Back</a>
		<a href="index.html" class="border-top m4 btn btn-primary text-center"
			style="margin-bottom: 10px; width: 150px; font-family: cursive; height: 35px; padding-top: 5px;">Home
			Page</a>
	</div>
	<form action="DeleteEmployeesevlet" method="post">
		<div class="container bg-light"
			...
			<h1
				style="text-decoration: underline; font-style: italic; font-family: cursive;">Delete
				Student Details:</h1>
			<hr>
